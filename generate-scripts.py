...
ipdb.export_vivado(script_path="fpga/pulpino-icbv1board-2020/pulpino/tcl/ips_src_files.tcl", alternatives=['riscv'])
...
ipdb.generate_vivado_add_files("fpga/pulpino-icbv1board-2020/pulpino/tcl/ips_add_files.tcl", alternatives=['riscv'])
...
ipdb.generate_vivado_inc_dirs("fpga/pulpino-icbv1board-2020/pulpino/tcl/ips_inc_dirs.tcl", alternatives=['riscv'])
